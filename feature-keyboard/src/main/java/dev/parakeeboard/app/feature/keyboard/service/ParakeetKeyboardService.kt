package dev.parakeeboard.app.feature.keyboard.service
...
import dev.parakeeboard.app.feature.keyboard.KeyboardPreferences
import dev.parakeeboard.app.feature.keyboard.haptic.HapticFeedback
import dev.parakeeboard.app.feature.keyboard.recorder.VoiceRecorder
import dev.parakeeboard.app.feature.keyboard.state.KeyboardState
import dev.parakeeboard.app.feature.keyboard.ui.KeyboardUI
import dev.parakeeboard.app.feature.llm.TextProcessor
import dev.parakeeboard.app.feature.llm.model.ProcessingMode
import dev.parakeeboard.app.feature.llm.repository.ProcessingModeRepository
...
class ParakeetKeyboardService : InputMethodService(), LifecycleOwner, SavedStateRegistryOwner {
    companion object {
        ...
        private const val MAIN_ACTIVITY_CLASS = "dev.parakeeboard.app.MainActivity"
    }
