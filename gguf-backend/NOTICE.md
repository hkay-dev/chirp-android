...
The trial backend builds against transcribe.cpp commit
...
converted to GGUF by handy-computer. The trial downloads the Q8_0 artifact from
the handy-computer Hugging Face repository and verifies its size and SHA-256
before activation.
