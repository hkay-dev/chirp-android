package dev.parakeeboard.app.feature.widget
...
import dev.parakeeboard.app.feature.widget.R
...
class RecordingWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TOGGLE_RECORDING = "dev.parakeeboard.app.TOGGLE_RECORDING"
        const val ACTION_UPDATE_WIDGET = "dev.parakeeboard.app.UPDATE_WIDGET"
