...
import dev.harsha.parakeeboard.feature.widget.R
...
class RecordingWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TOGGLE_RECORDING = "dev.harsha.parakeeboard.TOGGLE_RECORDING"
        const val ACTION_UPDATE_WIDGET = "dev.harsha.parakeeboard.UPDATE_WIDGET"
