...
Grab the APK from [GitHub Releases](https://github.com/hkay-dev/chirp-android/releases/latest).
Chirp 4.0 needs Android 16 and uses the compact Parakeet 110M GGUF model by default.
