...
| Quick-input focus handoff | Recognition activity hides the caller IME or delays success until its editor connection is stale | merged-manifest verification, `RecognitionDeliveryTest`, repeated Telegram and Twitter device checks | `:app:testDebugUnitTest`, `:app:processBetaManifest` |
