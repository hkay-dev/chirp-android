...
Archived from repo root (2026-05): `HARDENING_SPECIFICATION.md`, `RECORD_SCREEN_REDESIGN_PLAN.md`, `NAVIGATION_AUTOPSY.md`, `MOVIE_SYNC_RESPONSE.md`, `CHIRPBOARD_FUTURE_FEATURES*.md`, `PROCESSING_STUDIO_DESIGN_CONCEPTS.md`.

Do not use these for current architecture decisions.
